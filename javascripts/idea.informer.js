var reformal_wdg_domain = "OpenNumismat";
...
out_link = 'https://'+reformal_wdg_domain+'.idea.informer.com/proj/?mod=one';


if (dref_waction) 
{
		vlink = (typeof reformal_wdg_vlink != "undefined")  ? 'https://'+reformal_wdg_vlink : 'https://'+reformal_wdg_domain+'.idea.informer.com/proj/?mod=one';
}
else
{
...
MyOtzivCl = function() {
    var siteAdr = 'https://idea.informer.com/';
    ...
    this.mo_show_box = function() {
	    if (document.getElementById("fthere").innerHTML == "") {
		    document.getElementById("fthere").innerHTML = "<iframe src=\""+(vsiteAdr?'https://'+reformal_wdg_vlink+'/':siteAdr)+"wdg1v1.php?domain="+reformal_wdg_domain+"\" width=\"627\" height=\"250\" align=\"left\" style=\"border: 0; position:relative;\" frameborder=\"0\" scrolling=\"no\">Frame error</iframe>";
		}
